...
The goal of the project is to demonstrate the full process of domain discovery, strategic and tactical modelling, and then implementation using patterns such as Saga, Process Manager, CQRS, and CQS.
