...
* **Whenever `OrderPlaced`** → the order's lines are added to the open `Bill` and its running total is recalculated, matching `02_discover_process_level.md` §1.2's policy verbatim.
